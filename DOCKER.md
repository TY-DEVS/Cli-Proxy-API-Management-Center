...
- `CLI_PROXY_IMAGE`: backend image tag
...
2. If needed, update [.env](/c:/Users/amine/Desktop/Nouveau%20dossier/Cli-Proxy-API-Management-Center/.env) ports or image tag.
